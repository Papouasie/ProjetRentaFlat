...
public class ContactController  extends WebMvcConfigurerAdapter{
	...
	public String submitContact(Contact contact) throws MessagingException{
		...
		Properties props10 = System.getProperties();
        props10.put("mail.smtps.host","smtp.gmail.com");
        props10.put("mail.smtps.auth","true");
        Session session = Session.getInstance(props10, null);
        Message msg10 = new MimeMessage(session);
        
        //de la part de
        msg10.setFrom(new InternetAddress(mail_c));
        msg10.setRecipients(Message.RecipientType.TO,
        InternetAddress.parse("contact.rentaflat@gmail.com", false));//mail_c --> destinataire. Ici, formulaire de contact
        msg10.setSubject("Rent-a-flat.fr | Formulaire de contact"+System.currentTimeMillis());
