...
public class DetailsLogementController extends WebMvcConfigurerAdapter{
	...
	public String submitDemande(Model model, Contact demande, Logement log) throws MessagingException {
	    ...
	    //de la part de
	    msg1.setFrom(new InternetAddress("contact.rentaflat@gmail.com"));
        ...
        msg1.setSubject("Rent-a-flat.fr | Confirmation de votre demande de logement - "+System.currentTimeMillis());
        String texte = "<H1>Rent a flat.fr</H1>"
        		+" <h2>Demande de logement</h2>"
        		+ "<p>M, Mme "+nom_demandeur+"</p>"
        		+ "<p>Pour rappel, voici votre message : "+msg_demandeur+"</p>"
        		
        		+ "L'annonceur donnera suite prochainement à votre demande. "
        		+ "<br /><hr/><br/>"
        		+ "A bientôt, sur <b>rent-a-flat.fr</b> !";
        msg1.setContent(texte, "text/html");
	    ...
	    t1.connect("smtp.gmail.com", "contact.rentaflat@gmail.com", "vetbla&&");
	    ...
	    //de la part de
	    msg2.setFrom(new InternetAddress("contact.rentaflat@gmail.com"));
	    ...
	    msg2.setSubject("Rent-a-flat.fr | Demande de logement"+System.currentTimeMillis());
	    msg2.setText(
